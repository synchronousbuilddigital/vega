export default function StickyActions() {
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col gap-4">
      <a href="https://wa.me/919928927887" className="bg-[#25D366] hover:scale-110 transition-transform p-4 rounded-full shadow-2xl flex items-center justify-center">
      ...
      <a href="tel:+919928927887" className="bg-primary hover:scale-110 transition-transform p-4 rounded-full shadow-2xl flex items-center justify-center">
